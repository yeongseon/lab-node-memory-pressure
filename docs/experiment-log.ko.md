...
<p align="center"><em>그림 1: CPU% vs Memory% 시간별 추이</em></p>
...
<p align="center"><em>그림 2: 커널 페이지 Reclaim 활동</em></p>
...
<p align="center"><em>그림 3: Swap I/O 활동</em></p>
...
<p align="center"><em>그림 4: OS 메모리 세부 분석</em></p>
...
<p align="center"><em>그림 5: 앱별 RSS 메모리</em></p>
...
<p align="center"><em>그림 6: 버스트 트래픽 Latency 분포</em></p>
...
<p align="center"><em>그림 7: Traffic RPM vs CPU% vs Memory%</em></p>
...
<p align="center"><em>그림 8: CPU% vs Memory% 시간별 추이</em></p>
...
<p align="center"><em>그림 9: 커널 페이지 Reclaim 활동</em></p>
...
<p align="center"><em>그림 10: Swap I/O 활동</em></p>
...
<p align="center"><em>그림 11: 버스트 트래픽 Latency 분포</em></p>
...
<p align="center"><em>그림 12: Traffic RPM vs CPU% vs Memory%</em></p>
